...
#This code will allow generation of FTBS results for each of the
...
def FTBS_graph(nx,nt,condition):
    ...
    # Call in numerical advection code from function FTBS.
    ...
    plt.savefig('graphs_tables/FTBS_analysis_%d_%d_%d.pdf'%(nx,nt,condition), 
    bbox_inches = "tight")
